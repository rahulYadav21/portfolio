...
export default function StackIcon() {
  return (
    <>
      <div
        id="stack"
        className="container mx-auto w-auto h-auto lg:w-2/3 2xl:w-1/2"
      >
        ...
        <div className="skills_List">
          <div className="grid grid-rows-1 grid-cols-1 lg:grid-rows-1 lg:grid-cols-12">
            <div className="icons_left lg:col-span-5 2xl:col-span-5">
              {/* list of skills icon */}
              <div className="grid grid-cols-4 text-5xl lg:text-5xl 2xl:text-6xl mx-auto lg:gap-4 2xl:gap-4 text-gray-400">
            ...
            <div className="lg:col-span-7 2xl:col-span-7 text-justify">
              {/* list of skills */}
